...
export { default as StudentProfile } from "./singlePage/StudentProfile.jsx";
export { default as TeacherPlan } from "./homework/TeacherPlan.jsx";
export { default as StudentPlan } from "./homework/StudentPlan.jsx";
export { default as Attendance } from "./singlePage/Attendance.jsx";
export { default as Payment } from "./Payment.jsx";
export { default as HomeworkList } from "./homework/HomeworkList.jsx";
export { default as HomeworkDetail } from "./homework/HomeworkDetail.jsx";
export { default as TeacherHomeworkList } from "./homework/TeacherHomeworkList.jsx";
export { default as TeacherHomeworkDetails } from "./homework/TeacherHomeworkDetails.jsx";
export { default as TeacherSubmissions } from "./homework/TeacherHomeworkSubmissions.jsx";
export { default as CreateHomeworkWithExercises } from "./homework/CreateHomeworkExercises.jsx";
export { default as AdminShopping } from "./homework/AdminShopping.jsx";
export { default as StudentShopping } from "./homework/StudentShopping.jsx";